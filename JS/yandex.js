(function ymapsInit(e) {
    ...
    var s = function (e) {
            ...
            return l.exports = t, t.prototype.allowRemoteLoading = function () {
                ...
                if (e.key && e.storage) {
                    ...
                    for (var t = f.isArray(n.key) ? n.key : [n.key], r = 0, i = t.length; r < i; r++) this._definitionsByStorage[n.storage] = this._definitionsByStorage[n.storage] || {}, this._definitionsByStorage[n.storage][t[r]] = e
                }
    ...
    "vectorVersionTimestamp": 1617053121201,
    "cacheVersion": null,
    "type": "production",
    "flags": [],
    "server": {
    ...
    "layers": {
        "map": {
            "version": "21.03.29-2-b210309130700",
            "scaled": true,
        ...
        "sta": {
            "version": "2021.03.29.22.42-1_21.03.26-0-8548"
        },
        "trf": {
            "version": "1617052860",
            "scaled": true
    ...
    "token": "0e58e83fb8ad95fbd3888860425086be",
    "distribution": {},
    "version": "2.1.78",
    "majorVersion": "2.1",
